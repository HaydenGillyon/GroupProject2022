...
from frontend.auth_helper import get_sign_in_flow, get_token_from_code, store_user, remove_user_and_token, get_token
from frontend.graph_helper import *
...
def calendar(request):
  ...
  return render(request, 'frontend/calendar.html', context)
...
def newevent(request):
  ...
  if request.method == 'POST':
    ...
    if (not request.POST['ev-subject']) or \
      ...
      return render(request, 'frontend/newevent.html', context)
